...
#if MPI_DATATYPE_NULL != 0x0c000000
...
/* BEGIN CRAY ADDITION */
#define MPIX_STREAM_ISEND 1
#define MPIX_STREAM_IRECV 2
/* END CRAY ADDITION */
...
/* BEGIN CRAY ADDITION */
int MPIX_Comm_rankpool(MPI_Comm comm, const char *name, int timeout) MPICH_API_PUBLIC;
/* END CRAY ADDITION */

/* BEGIN CRAY ADDITION */
/* Stream triggered communication operations */
int MPIX_Isend_stream(const void *buf, int count, MPI_Datatype datatype,
                      int dest, int tag, MPI_Comm comm, MPI_Request *request,
                      void *stream) MPICH_API_PUBLIC;
int MPIX_Irecv_stream(void *buf, int count, MPI_Datatype datatype, int source,
                      int tag, MPI_Comm comm, MPI_Request *request,
                      void *stream) MPICH_API_PUBLIC;
int MPIX_Fence_stream(const int fence_op, void *stream) MPICH_API_PUBLIC;
/* END CRAY ADDITION */
...
/* BEGIN CRAY ADDITION */
int PMPIX_Comm_rankpool(MPI_Comm comm, const char *name, int timeout) MPICH_API_PUBLIC;
/* END CRAY ADDITION */

/* BEGIN CRAY ADDITION */
/* Stream triggered communication operations */
int PMPIX_Isend_stream(const void *buf, int count, MPI_Datatype datatype,
                       int dest, int tag, MPI_Comm comm, MPI_Request *request,
                       void *stream) MPICH_API_PUBLIC;
int PMPIX_Irecv_stream(void *buf, int count, MPI_Datatype datatype, int source,
                       int tag, MPI_Comm comm, MPI_Request *request,
                       void *stream) MPICH_API_PUBLIC;
int PMPIX_Fence_stream(const int fence_op, void *stream) MPICH_API_PUBLIC;
/* END CRAY ADDITION */
