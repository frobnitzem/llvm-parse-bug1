...
namespace MemorySpace
{
  ...
  struct MemorySpaceData
  {
    ...
    /**
     * Pointer to pinned memory host data.
     */
    std::unique_ptr<Number[]> values_host_pinned;
...
#  ifdef DEAL_II_COMPILER_CUDA_AWARE
  ...
  struct MemorySpaceData<Number, CUDA>
  {
    MemorySpaceData()
      ...
      , values_host_pinned(nullptr, Utilities::CUDA::delete_host_pinned_data<Number>)      
    {}
    ...
    std::unique_ptr<Number[], void (*)(Number *)>            values_host_pinned;
  ...
  swap(MemorySpaceData<Number, CUDA> &u, MemorySpaceData<Number, CUDA> &v)
  {
    ...
    std::swap(u.values_host_pinned, v.values_host_pinned);    
  }
