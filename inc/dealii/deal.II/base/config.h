...
#define DEAL_II_PACKAGE_VERSION "9.3.0-pre"

#define DEAL_II_VERSION_MAJOR 9
#define DEAL_II_VERSION_MINOR 3
...
#define DEAL_II_WITH_64BIT_INDICES
 ...
 */
 ...
 #  define DEAL_II_SUNDIALS_VERSION_MAJOR 0
 #  define DEAL_II_SUNDIALS_VERSION_MINOR 0
